...
/**
 * Test class for the FileReviewController REST controller.
 *
 * @see FileReviewController
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = ConferunsApp.class)
public class FileReviewControllerIntTest {
    ...
    public void setup() {
        ...
        final FileReviewController fileReviewController = new FileReviewController(fileReviewService);
        this.restFileReviewMockMvc = MockMvcBuilders.standaloneSetup(fileReviewController)
