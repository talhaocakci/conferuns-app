...
/**
 * Test class for the FileController REST controller.
 *
 * @see FileController
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = ConferunsApp.class)
public class FileControllerIntTest {
     ...
     *
     * @see com.btocakci.conferuns.repository.search.FileSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        this.restFileMockMvc = MockMvcBuilders.standaloneSetup(fileController)
