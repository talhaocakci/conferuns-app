...
export class Topic extends React.Component<ITopicProps, ITopicState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="topic-heading">
          <Translate contentKey="conferunsApp.conferunsTopic.home.title">Topics</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="conferunsApp.conferunsTopic.home.createLabel">Create new Topic</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('conferunsApp.conferunsTopic.home.search')}
                  />
