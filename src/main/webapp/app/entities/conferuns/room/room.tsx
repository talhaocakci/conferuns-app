...
import { getSearchEntities, getEntities } from './room.reducer';
...
export class Room extends React.Component<IRoomProps, IRoomState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="room-heading">
          <Translate contentKey="conferunsApp.conferunsRoom.home.title">Rooms</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="conferunsApp.conferunsRoom.home.createLabel">Create new Room</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('conferunsApp.conferunsRoom.home.search')}
                  />
