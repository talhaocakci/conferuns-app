...
export class File extends React.Component<IFileProps, IFileState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="file-heading">
          <Translate contentKey="conferunsApp.conferunsFile.home.title">Files</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="conferunsApp.conferunsFile.home.createLabel">Create new File</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('conferunsApp.conferunsFile.home.search')}
                  />
