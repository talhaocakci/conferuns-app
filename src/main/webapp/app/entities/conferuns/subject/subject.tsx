    ...
    return (
      <div>
        <h2 id="subject-heading">
          <Translate contentKey="conferunsApp.conferunsSubject.home.title">Subjects</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="conferunsApp.conferunsSubject.home.createLabel">Create new Subject</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('conferunsApp.conferunsSubject.home.search')}
                  />
