...
export const Topic = (props: ITopicProps) => {
  ...
  const { topicList, match } = props;
  return (
    <div>
      <h2 id="topic-heading">
        <Translate contentKey="conferunsApp.topic.home.title">Topics</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="conferunsApp.topic.home.createLabel">Create new Topic</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {topicList && topicList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="conferunsApp.topic.home.notFound">No Topics found</Translate>
          </div>
        )}
      </div>
    </div>
