...
export const Fee = (props: IFeeProps) => {
  ...
  const { feeList, match } = props;
  return (
    <div>
      <h2 id="fee-heading">
        <Translate contentKey="conferunsApp.fee.home.title">Fees</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="conferunsApp.fee.home.createLabel">Create new Fee</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {feeList && feeList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="conferunsApp.fee.home.notFound">No Fees found</Translate>
          </div>
        )}
      </div>
    </div>
