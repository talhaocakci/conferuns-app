...
export const FeeDeleteDialog = (props: IFeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="conferunsApp.fee.delete.question">
        <Translate contentKey="conferunsApp.fee.delete.question" interpolate={{ id: feeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-fee" color="danger" onClick={confirmDelete}>
