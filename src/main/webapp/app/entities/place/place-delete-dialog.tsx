...
export const PlaceDeleteDialog = (props: IPlaceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="conferunsApp.place.delete.question">
        <Translate contentKey="conferunsApp.place.delete.question" interpolate={{ id: placeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-place" color="danger" onClick={confirmDelete}>
